        ...
        <section :class="$style.content">
            <div :class="$style.item" v-for="item in items" :key="item.catory">
                ...
                <section :class="$style.list">
                    <div :class="$style.product" v-for="li in item.list" :key="li.title">
                        <img :src="li.img" alt="">
                        <p :class="$style.title">{{ li.title }}</p>
                        <p :class="$style.price"> <em>{{ li.price }}</em>起</p>
                        <article>
                            <div :class="$style.wrapper">
                                <div :class="$style.inner" :style="{width:li.progress+'%'}"/>
                            </div>
                            <p>{{ li.progress }}%</p>
                        </article>
                        <label v-if="li.select">精选</label>
